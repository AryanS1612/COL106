...
class PointDatabase:
    ...
    def sort(self,lst): # implementing sorting, for sorting the list in x co-ordinate.
    ...
    def search_min_x(self,x):# binary search for finding lower bound in the list sorted in terms x co-ordinate.
        lst = self.sort_x
    ...
    def search_max_x(self,x):# binary search for finding upper bound in the list sorted in terms x co-ordinate.
        lst = self.sort_x
    ...
    def segment_tree(self,lst):# creating segment tree in terms of y co-ordinate
        def Merge_Sort(lst,l,r):
            mid = int((l+r)/2)
            if(l == r):
                a = lst[l:l+1]
    ...
    def range_interval_x(self,tup,d):
        # finds range in terms of list index in the x-sorted list
        lower = tup[0] - d
        upper = tup[0] + d
    ...
    def tree_traverse(self,tup,d):
        ...
        range_x = self.range_interval_x(tup,d)
    ...
    def searchNearby(self,tup,d):
        if(self.sort_x == []) or (d == 0):
            return []
        return self.tree_traverse(tup,d)


# pointDbObject = PointDatabase([(2,4), (9,2), (5,1), (7,8), (3,7), (10,5), (4,9), (8,10), (1,6), (6,3)])
